...
Seekbar = function() {
	...
	this.set_size = function(x, y, w, h) {
		...
		slider_y = Math.floor((this.h - slider_h) / 2);
	};
...
function set_btns() {
	g_btns = [];
	// playback control
	g_btns[0] = new Button(images.prev);
	g_btns[1] = new Button(images.play, null);
	g_btns[2] = new Button(images.next);
	g_btns[3] = new Button(images.add);
};
